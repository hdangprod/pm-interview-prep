...
[Home](../README.md) · [Roadmap](../ROADMAP.md) · [Gemini prompt](../gemini/COACH_PROMPT.md)

Each note works in a 10–30-minute visit. Read one section, explain its example aloud, then answer its check-yourself questions without looking.
...
Then choose a [Katalon case](../katalon/CASES.md) or [ShopeeFood case](../shopeefood/CASES.md). The notes teach ideas; the case banks leave room for your own reasoning.

Examples are hypothetical unless explicitly sourced. None describes Dang's achievements.
