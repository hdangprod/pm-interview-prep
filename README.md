...
Prepare for **Katalon PM Intern** and **ShopeeFood APM** on September 16, 2026.
...
- **Find the words:** [English phrase bank](pm-interview-bootcamp/english/phrase-bank.md).

Pick today's goal → read one short section → discuss it with Gemini → apply it → answer aloud → adjust your pace.

No daily reports or scorecard maintenance. You decide where to spend more time.

[Research, stories and previous coaching history](pm-interview-bootcamp/reference/README.md) are optional reference. Raw evidence stays separate from polished stories.
